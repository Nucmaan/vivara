...
export default function BuyPage() {
  ...
  const goToDetails = (id: number) => router.push(`/buy/${id}`);
      ...
      <div className="bg-white border-b border-[#E2E2E2]">
        <div className="max-w-[1200px] mx-auto px-5 py-8">
          <h1 className="text-[32px] font-bold text-[#282828] mb-1">
            Properties for <span className="text-[#00875A]">Sale</span> in Somalia
          </h1>
          <p className="text-[16px] text-[#666666]">
            Browse {listings.length} properties for sale across Mogadishu, Hargeisa & more
          </p>
